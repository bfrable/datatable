    ...
    <div>
      ...
      >
        <ucrsdtnet-datatable-column name="Name">
          <ng-template ucrsdtnet-datatable-cell-template let-rowIndex="rowIndex" let-value="value" let-row="row">
            <span
        ...
        <ucrsdtnet-datatable-column name="Gender">
          <ng-template ucrsdtnet-datatable-cell-template let-rowIndex="rowIndex" let-row="row" let-value="value">
            <span
              title="Double click to edit"
        ...
        <ucrsdtnet-datatable-column name="Age">
          <ng-template ucrsdtnet-datatable-cell-template let-value="value">
            {{ value }}
          </ng-template>
        </ucrsdtnet-datatable-column>
      </ucrsdtnet-datatable>
