  ...
  template: `
    <div>
      ...
      >
        ...
        <ucrsdtnet-datatable-group-header [rowHeight]="50" #myGroupHeader (toggle)="onDetailToggle($event)">
          <ng-template let-group="group" let-expanded="expanded" ucrsdtnet-datatable-group-header-template>
        ...
        </ucrsdtnet-datatable-group-header>

        <!-- Row Column Template -->
        <ucrsdtnet-datatable-column name="Exp. Pay." prop="" editable="true" frozenLeft="True">
          <ng-template
            ucrsdtnet-datatable-cell-template
        ...
        <ucrsdtnet-datatable-column name="Source" prop="source" editable="false" frozenLeft="True"></ucrsdtnet-datatable-column>
        <ucrsdtnet-datatable-column name="Name" prop="name" editable="true"></ucrsdtnet-datatable-column>
        <ucrsdtnet-datatable-column name="Gender" prop="gender"></ucrsdtnet-datatable-column>
        <ucrsdtnet-datatable-column name="Age" prop="age"></ucrsdtnet-datatable-column>
        <ucrsdtnet-datatable-column name="Comment" prop="comment">
          <ng-template
            ucrsdtnet-datatable-cell-template
            let-rowIndex="rowIndex"
            let-value="value"
