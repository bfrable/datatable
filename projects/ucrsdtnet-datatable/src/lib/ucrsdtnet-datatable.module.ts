...
export class DatatableModule {
  /**
   * Configure global configuration via IDatatableConfig
   * @param configuration
   */
  static forRoot(configuration: IDatatableConfig): ModuleWithProviders<DatatableModule> {
    return {
...
/**
 * Interface definition for IDatatableConfig global configuration
 */
