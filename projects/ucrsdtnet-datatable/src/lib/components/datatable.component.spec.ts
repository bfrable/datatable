...
import { DatatableModule } from '../ucrsdtnet-datatable.module';
...
describe('DatatableComponent With Custom Templates', () => {
  ...
  it('should reflect changes to input bindings of `ucrsdtnet-datatable-column`', () => {
    const initialRows = [
...
@Component({
  template: ` <ucrsdtnet-datatable [columns]="columns" [rows]="rows" [sorts]="sorts"> </ucrsdtnet-datatable> `
})
...
@Component({
  template: `
    <ucrsdtnet-datatable [rows]="rows" [sorts]="sorts">
      <ucrsdtnet-datatable-column name="Id" prop="id">
        <ng-template let-column="column" ucrsdtnet-datatable-header-template>
          {{ column.name }}
        </ng-template>
      ...
      <ucrsdtnet-datatable-column [prop]="columnTwoProp">
        <ng-template let-column="column" ucrsdtnet-datatable-header-template>
          {{ column.name }}
        </ng-template>
        <ng-template let-row="row" let-column="column" ucrsdtnet-datatable-cell-template>
          {{ row[column.prop] }}
        </ng-template>
      </ucrsdtnet-datatable-column>
    </ucrsdtnet-datatable>
 ...
 * body of the ucrsdtnet-datatable component
 */
