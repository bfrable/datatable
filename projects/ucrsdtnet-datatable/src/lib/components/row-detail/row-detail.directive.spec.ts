...
@Component({
  ...
  template: `
    <ucrsdtnet-datatable-row-detail id="t1"></ucrsdtnet-datatable-row-detail>
    <ucrsdtnet-datatable-row-detail id="t2">
      <ng-template ucrsdtnet-datatable-row-detail-template></ng-template>
