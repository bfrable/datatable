...
@Component({
  ...
  template: `
    <ucrsdtnet-datatable-group-header id="t1"></ucrsdtnet-datatable-group-header>
    <ucrsdtnet-datatable-group-header id="t2">
      <ng-template ucrsdtnet-datatable-group-header-template></ng-template>
